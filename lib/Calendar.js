...
require('./addons/dragAndDrop/styles.less');
...
Calendar.propTypes = {
  ...
  /**
    ...
    */
  statusHeadings: _propTypes2.default.arrayOf(_propTypes2.default.object),
  ...
  customNavigate: _propTypes2.default.func,
...
Calendar.defaultProps = {
  ...
  views: [_constants.views.MONTH, _constants.views.WEEK, _constants.views.DAY, _constants.views.AGENDA, _constants.views.RESOURCE, _constants.views.STATUS],
  date: now,
  step: 30,
  ...
  staffAccessor: _propTypes3.accessor,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.customNavigate = function () {
    var customNavigate = _this2.props.customNavigate;
