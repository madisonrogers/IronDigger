...
var ResourceGrid = function (_Component) {
  ...
  ResourceGrid.prototype.componentWillMount = function componentWillMount() {
    this._gutters = [];
    this.calculateScroll();
  };

  ResourceGrid.prototype.componentDidMount = function componentDidMount() {
    this.checkOverflow();
  ...
  ResourceGrid.prototype.componentWillUnmount = function componentWillUnmount() {
    window.clearTimeout(this._timeIndicatorTimeout);
  };

  ResourceGrid.prototype.componentDidUpdate = function componentDidUpdate() {
  ...
  ResourceGrid.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  ResourceGrid.prototype.render = function render() {
    var _this2 = this;
  ...
  ResourceGrid.prototype.renderEvents = function renderEvents(range, events, today, id) {
    var _this3 = this;
    ...
    return range.map(function (date, idx) {
      ...
      var daysEvents = events.filter(function (event) {
        return _dates2.default.inRange(date, (0, _accessors.accessor)(event, startAccessor), (0, _accessors.accessor)(event, endAccessor), 'day') && event.statusId === id;
      });

      return _react2.default.createElement(_DayColumn2.default, _extends({}, _this3.props, (_extends2 = {
        key: id,
        resource: id,
      ...
      }, _extends2['key'] = idx, _extends2.date = date, _extends2.events = daysEvents, _extends2)));
    });
  };

  ResourceGrid.prototype.renderResourceHeader = function renderResourceHeader(range, events, width, statusHeadings) {
    var _this4 = this;
  ...
  ResourceGrid.prototype.renderHeaderCells = function renderHeaderCells(range, id, title) {
    var _this5 = this;
  ...
  ResourceGrid.prototype.handleSelectEvent = function handleSelectEvent() {
  ...
  ResourceGrid.prototype.clearSelection = function clearSelection() {
    clearTimeout(this._selectTimer);
    this._pendingSelection = [];
  };

  ResourceGrid.prototype.measureGutter = function measureGutter() {
  ...
  ResourceGrid.prototype.applyScroll = function applyScroll() {
  ...
  ResourceGrid.prototype.calculateScroll = function calculateScroll() {
  ...
  ResourceGrid.prototype.checkOverflow = function checkOverflow() {
    var _this6 = this;
  ...
  ResourceGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
  ...
  ResourceGrid.prototype.triggerTimeIndicatorUpdate = function triggerTimeIndicatorUpdate() {
    var _this7 = this;
...
ResourceGrid.propTypes = {
  ...
  statusHeadings: _react2.default.PropTypes.array.isRequired,
  ...
  businessHours: _react2.default.PropTypes.array
};
