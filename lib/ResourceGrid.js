...
var ResourceGrid = function (_Component) {
  ...
  ResourceGrid.prototype.renderEvents = function renderEvents(range, events, today, id) {
    ...
    return range.map(function (date, idx) {
      ...
      var daysEvents = events.filter(function (event) {
        return _dates2.default.inRange(date, (0, _accessors.accessor)(event, startAccessor), (0, _accessors.accessor)(event, endAccessor), 'day') && event.resourceId === id;
      });
  ...
  ResourceGrid.prototype.renderResourceHeader = function renderResourceHeader(range, events, width, resources) {
    var _this4 = this;
