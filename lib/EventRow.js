  ...
  EventRow.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      segments.reduce(function (row, _ref, li) {
        ...
        if (gap) row.push(_EventRowMixin2.default.renderSpan(_this2.props, gap, key + '_gap')); // @Manish smartdata - , left - remove comment if not used

        row.push(_EventRowMixin2.default.renderSpan(_this2.props, span, key, content, left));
