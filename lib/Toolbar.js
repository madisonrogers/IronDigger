...
var Toolbar = function (_React$Component) {
  ...
  Toolbar.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'span',
        { className: 'rbc-toolbar-label monthlabel' },
        label
      ),
      _react2.default.createElement(
        'span',
        { className: 'next_pri-btn' },
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.navigate.bind(null, _constants.navigate.PREVIOUS) },
          _react2.default.createElement('i', { className: 'fa fa-angle-left', 'aria-hidden': 'true' })
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.navigate.bind(null, _constants.navigate.NEXT) },
          _react2.default.createElement('i', { className: 'fa fa-angle-right', 'aria-hidden': 'true' })
        )
      ),
      _react2.default.createElement(
        'span',
        { className: 'rbc-btn-group monthweekbtn' },
        _react2.default.createElement(
          'button',
          {
            type: 'button',
  ...
  Toolbar.prototype.viewNamesGroup = function viewNamesGroup(messages) {
    ...
    var viewType = width < 768 ? 'day' : 'month';
